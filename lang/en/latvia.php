...
$smarty->assign('title', 'Курсы валют ЦБ Латвии');
...
$smarty->assign('caption','Официальный курс латвийского лата по отношению к иностранным валютам, устанавливаемый Центральным банком Латвии ежедневно.');
