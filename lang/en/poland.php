...
$smarty->assign('title', 'Курсы валют НБ Польши');
...
$smarty->assign('caption','Официальный курс польского злотого по отношению к иностранным валютам, устанавливаемый Национальным банком Польши ежедневно.');
