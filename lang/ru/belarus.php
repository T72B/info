...
$smarty->assign('title', 'Курсы валют НБ РБ');
$smarty->assign('massiv', $mas);
$smarty->assign('date', str_replace("/",".",$today_caption));
$smarty->assign('description','Курсы валют национального банка на ');
$smarty->assign('lang', $lang);
$smarty->assign('langEnUrl', 'http://'.$langEnUrl);
$smarty->assign('langRuUrl', 'http://'.$langRuUrl);
$smarty->assign('keywords', 'Курсы валют, национальный банк, нацбанк, банк, валюта,экономика, mysite, mysite13, mysite13.net, mysite13.net.78, mysite13.net78.net');
$smarty->assign('menu_href', $menu_href);
$smarty->assign('menu_caption', $menu_caption[$lang]);
$smarty->assign('menu_class',$menu_arr );
$smarty->assign('caption', 'Официальный курс белорусского рубля по отношению к иностранным валютам, устанавливаемый Национальным банком Республики Беларусь ежедневно.');
